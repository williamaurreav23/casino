...
public class UserExtraResourceIT {
    ...
    public void setup() {
        ...
        final UserExtraResource userExtraResource = new UserExtraResource(userExtraRepository, userRepository);
    ...
    public void createUserExtra() throws Exception {
        ...
        assertThat(testUserExtra.getTransaction()).isEqualTo(DEFAULT_TRANSACTION);
    ...
    public void updateUserExtra() throws Exception {
        ...
        UserExtra testUserExtra = userExtraList.get(userExtraList.size() - 1);
        assertThat(testUserExtra.getTransaction()).isEqualTo(UPDATED_TRANSACTION);
    }
