package at.sebastian

import at.sebastian.config.ApplicationProperties
import at.sebastian.config.addDefaultProfile
...
class CasinoApp(private val env: Environment) : InitializingBean {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<CasinoApp>(*args) { addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(CasinoApp::class.java)
